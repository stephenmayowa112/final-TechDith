...
export const metadata: Metadata = {
  ...
  description: "Stay updated with the latest tech insights, industry trends, and company news from TECHDITH LIMITED.",
}
    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="relative h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Blog & News</h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            Tech insights, industry trends, and company updates from TECHDITH LIMITED
          </p>
        </div>
      </section>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-3xl font-bold mb-12 text-center text-gray-800">
              <span className="inline-block pb-2 border-b-4 border-emerald-500">Featured Article</span>
            </h2>
                ...
                <div className="lg:w-1/2 p-8">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
                      <span className="text-emerald-700 font-bold">{featuredPost.author.charAt(0)}</span>
                    </div>
                    <div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold mb-12 text-center text-gray-800">
            <span className="inline-block pb-2 border-b-4 border-emerald-500">Latest Articles</span>
          </h2>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 bg-emerald-100 rounded-full flex items-center justify-center">
                        <span className="text-emerald-700 font-bold text-xs">{post.author.charAt(0)}</span>
                      </div>
          ...
          <div className="mt-12 flex justify-center">
            <nav className="flex items-center gap-2">
              ...
              <button className="w-10 h-10 flex items-center justify-center rounded-lg bg-emerald-600 text-white">
                1
              </button>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-1/2">
                <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800">Stay Updated with Our Newsletter</h2>
                <p className="text-gray-700 mb-6">
                  Subscribe to our newsletter to receive the latest tech insights, industry trends, and company updates
